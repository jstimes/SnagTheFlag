...
const getGrenadeSmokeParticleSystemParams = (startPositionCanvas: Point): ParticleSystemParams => {
    return {
        startPositionCanvas,
        particleCount: 160,
        colorA: '#a1a1a1',
...
const getGrenadeBurstParticleSystemParams = (startPositionCanvas: Point): ParticleSystemParams => {
    return {
        startPositionCanvas,
        particleCount: 100,
        colorA: '#e3a14f',
